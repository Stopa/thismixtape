...
{% unless editmode %}<meta property="og:audio" content="{% content name="player" %}" /> {% endunless %}
...
{% if editmode %}
        ...
        {% content name="player" %}
      {% else %}
        <div id="download" class="download"><h3><a href="{% content name="player" %}">Download</a></h3></div>
      {% endif %}
